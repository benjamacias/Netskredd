...
api = TikTokApi.get_instance(custom_verifyFp="your_verifyFp", use_test_endpoints=True)
api.login_with_username_and_password("your_username", "your_password")
...
# Uso de la función
tiktok_upload("videoprueba", r"C:\Users\benja\Downloads\boots_-_11256 (540p).mp4")
